...
import { CommandPalette } from '../../command-palette/views'
import type { PaletteAction } from '../../command-palette/models/command-palette.model'
...
import { useKeymapViewModel } from '../../keymap/viewmodels/useKeymapViewModel'
