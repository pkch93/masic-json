...
import { JsonEditor } from '../../top/editor/views'
import type { JsonEditorHandle } from '../../top/editor/views'
import { JsonTreeView } from '../../bottom/json-tree/views'
import { QueryView } from '../../bottom/query/views'
import type { QueryViewHandle } from '../../bottom/query/views'
import { SortView } from '../../bottom/sort/views'
import type { SortViewHandle } from '../../bottom/sort/views'
import { useFormatterViewModel } from '../viewmodels/useFormatterViewModel'
import { KeyMappingPanel } from '../../settings/keymap/views'
import type { KeymapViewModel } from '../../settings/keymap/viewmodels/useKeymapViewModel'
import type { IndentSize } from '../models/formatter.model'
import type { HistoryEntry, HistoryOperation } from '../../settings/history/models/history.model'
import { formatRelativeTime, formatByteSize } from '../../settings/history/services/history.service'
import './style.css'
...
export interface FormatterViewHandle {
  format: () => void
  minify: () => void
  clear: () => void
  find: () => void
...
export const FormatterView = forwardRef<FormatterViewHandle, FormatterViewProps>(
  function FormatterView(
    {
      keymapVM,
      onSave,
      pendingLoad,
    ...
    useImperativeHandle(ref, () => ({
      ...
      getRawJson: () => rawJson
    }), [format, minify, clear, focusBottomTab, rawJson])
